...
(function () {
  ...
  const T = {
    ...
    'index.diff.h':     { en:'NullVPN is different.', ru:'NullVPN — другой.', fa:'NullVPN متفاوت است.', ar:'NullVPN مختلف.', es:'NullVPN es diferente.', ne:'NullVPN फरक छ।', zh:'NullVPN 与众不同。' },
